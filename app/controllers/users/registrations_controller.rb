class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def sign_up_params
    params.require(:user).permit(:email, :password, :password_confirmation, :first_name, :last_name, :mother_last_name, :username, :restaurant_id,
  ...
  def profile_update_params
    params.require(:user).permit(:email, :current_password, :password, :password_confirmation, :first_name, :last_name, :username, :restaurant_id,
